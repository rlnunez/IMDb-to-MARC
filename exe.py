...
for video in video_list:
    ...
    record.add_ordered_field(Field(tag = '040',indicators = [' ',' '],subfields = ['a', 'WIK' ,'b', lanugage_lookup(worldcatRecord['language'][0]) ,'c', 'WIK' , 'e', 'rda' ]))
    ...
    #905 - Generator Notes
    record.add_ordered_field(Field(tag = '905',indicators = [' ',' '],subfields = ['a', 'This record was generated by the Kenosha Public Library IMDb + OCLC to Marc Python Script', 'v', version]))
    #Set leader info
